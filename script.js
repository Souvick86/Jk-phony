...
btn.addEventListener('click', function () {
  ...
  a.innerHTML = ''; // Clear any existing text

  btn.disabled = true; // Disable button while joke is being displayed
  ...
  setTimeout(function () {
    btn.disabled = false; // Re-enable button after joke has been displayed
  }, joke.length * 40); // Wait for joke to finish before re-enabling button
});
